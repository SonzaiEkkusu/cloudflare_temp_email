...
const messages: LocaleMessages = {
    ...
    TgWelcomeMsg: "Selamat datang di bot ini, Anda dapat membuka aplikasi mini",
    ...
    TgMsgTooLongMsg: "Pesan terlalu panjang, silakan lihat di aplikasi mini",
    TgParseFailedViewInAppMsg: "Gagal mengurai, silakan lihat di aplikasi mini",
